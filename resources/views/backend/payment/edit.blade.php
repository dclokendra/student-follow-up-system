    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Payment
                    <a href="{{route('payment.create')}}" class="btn btn-inprimaryfo"><i class="fa fa-plus"></i>Create</a>
            ...
            <div class="row">
                {!! Form::model($data['payment'],['route' => ['payment.update',$data['payment']->id], 'method' => 'PUT','files' => true]) !!}
                @csrf
                <div class="col-md-12">
                @include('backend.payment.includes.main_form')
                <!-- /.box-body -->

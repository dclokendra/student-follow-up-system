...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('section.create')}}">Section</a></li>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Create Section
            ...
            <div class="row"> {!! Form::open(['route' => 'section.store', 'method' => 'POST','files' => true]) !!}
               @csrf
                <div class="col-md-12">
                    @include('backend.section.includes.main_form')
                    <!-- /.box-body -->

...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('parent.create')}}">Parent</a></li>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Create Parent
            ...
            <div class="row"> {!! Form::open(['route' => 'parent.store', 'method' => 'POST','files' => true]) !!}
               @csrf
                <div class="col-md-12">
                    @include('backend.parent.includes.main_form')
                    <!-- /.box-body -->
